const themeToggle = document.getElementById('theme-toggle');
        ...
        const blueBeltQuestions = [
            { verb: "construire", answer: "build built built" },
            { verb: "brûler", answer: "burn burnt burnt" },
            { verb: "rêver", answer: "dream dreamt dreamt" },
            { verb: "se sentir/éprouver", answer: "feel felt felt" },
            { verb: "combattre", answer: "fight fought fought" },
            { verb: "garder", answer: "keep kept kept" },
            { verb: "apprendre", answer: "learn learnt learnt" },
            { verb: "laisser/quitter", answer: "leave left left" },
            { verb: "perdre", answer: "lose lost lost" },
            { verb: "signifier", answer: "mean meant meant" },
            { verb: "(se) rencontrer", answer: "meet met met" },
            { verb: "dormir", answer: "sleep slept slept" },
            { verb: "dépenser/passer du temps", answer: "spend spent spent" },
            { verb: "enseigner", answer: "teach taught taught" }
        ];
